...
namespace Data.Migrations
{
    ...
    [Migration("20220703204350_Juegos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modelos.ApelacionModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.ApuestaModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");

                    b.Property<string>("Apuesta")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.AutoBumpModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.BalanceModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.JuegoModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.MediaPropiedadesModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("MediasPropiedades");
                });

            modelBuilder.Entity("Modelos.MensajeGlobalModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.PedidoCodigoPremiumModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");

                    b.Property<string>("CodigoMembreciaId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.TransaccionModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<float>("DestinoCantidad")
                        .HasColumnType("real");

                    b.Property<string>("DestinoUnidad")
                        .HasColumnType("text");

                    b.Property<float>("OrigenCantidad")
                        .HasColumnType("real");

                    b.Property<string>("OrigenUnidad")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modelos.ApuestaModel", b =>
                {
                    b.HasOne("Modelos.ComentarioModel", "Comentario")
                        .WithOne()
                        .HasForeignKey("Modelos.ApuestaModel", "ComentarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Modelos.JuegoModel", "Juego")
                        .WithMany()
            ...
            modelBuilder.Entity("Modelos.BalanceModel", b =>
                {
                    b.HasOne("Modelos.UsuarioModel", "Usuario")
                        .WithOne()
                        .HasForeignKey("Modelos.BalanceModel", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Modelos.MediaPropiedadesModel", b =>
                {
                    b.HasOne("Modelos.MediaModel", "Media")
                        .WithOne()
                        .HasForeignKey("Modelos.MediaPropiedadesModel", "MediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Modelos.PedidoCodigoPremiumModel", b =>
                {
                    b.HasOne("Modelos.CodigoPremiumModel", "CodigoMembrecia")
                        .WithMany()
                        .HasForeignKey("CodigoMembreciaId");

                    b.HasOne("Modelos.CodigoPremiumModel", "CodigoPaquete")
                        .WithMany()
